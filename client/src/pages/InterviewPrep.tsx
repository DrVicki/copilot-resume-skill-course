 ...
 * This companion page is an evidence-led rehearsal studio, not a generic
...
const heroImage = "/manus-storage/interview-proofroom-hero_5d97aea2.png";
const brandMark = "/manus-storage/proofwork-mark-v2_dfa688dd.png";
const proofroomMark = "/manus-storage/interview-proofroom-mark_c10c7510.png";
    ...
    <div className="site-shell proofroom-page">
      <header className="site-header proofroom-header">
        <div className="container header-inner">
          <a href="/" className="brand-lockup" aria-label="Proofwork resume course home">
          ...
          <a href="/" className="companion-switch">
            <ArrowLeft size={15} /> Resume lab
          </a>
      ...
      <main id="top">
        ...
        <section className="instructor-section" aria-labelledby="interview-instructor-heading">
          <div className="container instructor-card proofroom-instructor-card">
            ...
            <div className="instructor-copy">
              ...
              <p>
                This companion course treats practice as a working studio. Every lesson produces a
        ...
        <CourseStudio
          ...
          storageKey="proofwork-interview-course-state-v1"
      ...
      <footer className="site-footer proofroom-footer">
        <div className="container footer-inner">
          <div className="brand-lockup footer-brand">
            <img src={proofroomMark} alt="" className="brand-mark" />
            <span>
          ...
          <a href="/">Resume course <ArrowRight size={15} /></a>
        </div>
      </footer>
    </div>
  );
